...
mod tests {
    ...
    fn test_parsing_vscode_launch_json() {
        ...
        let monyacode = DebugTaskFile::try_from(parsed).expect("converting to MonyaCode debug templates");
        pretty_assertions::assert_eq!(
            ...
            DebugTaskFile(vec![DebugScenario {
                ...
                config: json!({
                    "request": "launch",
                    "program": "${MONYACODE_WORKTREE_ROOT}/xyz.js",
                    "showDevDebugOutput": false,
                    "stopOnEntry": true,
                    "args": [
                        "--foo",
                        "${MONYACODE_WORKTREE_ROOT}/thing",
                    ],
                    "cwd": "${MONYACODE_WORKTREE_ROOT}/${FOO}/sub",
                    "env": {
                        "X": "Y",
                    },
                    "type": "node",
