    ...
    const MIGRATIONS: &[&str] = &[
        sql!(
            CREATE TABLE workspaces(
                ...
                dock_visible INTEGER, // Deprecated. Preserving so users can downgrade MonyaCode.
                dock_anchor TEXT, // Deprecated. Preserving so users can downgrade MonyaCode.
                dock_pane INTEGER, // Deprecated.  Preserving so users can downgrade MonyaCode.
        ...
        // Preserving so users can downgrade MonyaCode.
        sql!(
...
impl WorkspaceDb {
    ...
    // session was closed (i.e. when MonyaCode was quit).
