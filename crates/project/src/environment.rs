...
impl ProjectEnvironment {
    ...
    /// Returns the inherited CLI environment, if this project was opened from the MonyaCode CLI.
...
fn set_origin_marker(env: &mut HashMap<String, String>, origin: EnvironmentOrigin) {
    env.insert(MONYACODE_ENVIRONMENT_ORIGIN_MARKER.to_string(), origin.into());
}

const MONYACODE_ENVIRONMENT_ORIGIN_MARKER: &str = "MONYACODE_ENVIRONMENT";
