        ...
        pretty_assertions::assert_eq!(
            ...
            [
                (
                    ...
                    Some("$MONYACODE_CUSTOM_TYPESCRIPT_VITEST_PACKAGE_PATH".into()),
                ),
                (
                    "vitest test $MONYACODE_SYMBOL".into(),
                    Some("$MONYACODE_CUSTOM_TYPESCRIPT_VITEST_PACKAGE_PATH".into()),
                ),
                (
                    "mocha file test".into(),
                    Some("$MONYACODE_CUSTOM_TYPESCRIPT_MOCHA_PACKAGE_PATH".into()),
                ),
                (
                    "mocha test $MONYACODE_SYMBOL".into(),
                    Some("$MONYACODE_CUSTOM_TYPESCRIPT_MOCHA_PACKAGE_PATH".into()),
                ),
