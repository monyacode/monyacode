...
mod tests {
    ...
    fn test_parse_remote_url_given_ssh_url() {
        let parsed_remote = Bitbucket::public_instance()
            .parse_remote_url("git@bitbucket.org:monyacode/monyacode.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_https_url() {
        let parsed_remote = Bitbucket::public_instance()
            .parse_remote_url("https://bitbucket.org/monyacode/monyacode.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_https_url_with_username() {
        let parsed_remote = Bitbucket::public_instance()
            .parse_remote_url("https://MonyaCode@bitbucket.org/monyacode/monyacode.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_self_hosted_ssh_url() {
        let remote_url = "git@bitbucket.company.com:monyacode/monyacode.git";
    ...
    fn test_parse_remote_url_given_self_hosted_https_url() {
        let remote_url = "https://bitbucket.company.com/monyacode/monyacode.git";
    ...
    fn test_parse_remote_url_given_self_hosted_https_url_with_username() {
        let remote_url = "https://MonyaCode@bitbucket.company.com/monyacode/monyacode.git";
    ...
    fn test_build_bitbucket_permalink() {
        ...
        let expected_url = "https://bitbucket.org/monyacode/monyacode/src/f00b4r/main.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }

    #[test]
    fn test_build_bitbucket_self_hosted_permalink() {
        let permalink = Bitbucket::from_remote_url("git@bitbucket.company.com:monyacode/monyacode.git")
            .unwrap()
            .build_permalink(
                ParsedGitRemote {
                    owner: "MonyaCode".into(),
        ...
        let expected_url = "https://bitbucket.company.com/projects/MonyaCode/repos/monyacode/browse/main.rs?at=f00b4r";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_bitbucket_permalink_with_single_line_selection() {
        ...
        let expected_url = "https://bitbucket.org/monyacode/monyacode/src/f00b4r/main.rs#lines-7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }

    #[test]
    fn test_build_bitbucket_self_hosted_permalink_with_single_line_selection() {
        let permalink = Bitbucket::from_remote_url("https://bitbucket.company.com/monyacode/monyacode.git")
            .unwrap()
            .build_permalink(
                ParsedGitRemote {
                    owner: "MonyaCode".into(),
        ...
        let expected_url =
            "https://bitbucket.company.com/projects/MonyaCode/repos/monyacode/browse/main.rs?at=f00b4r#7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_bitbucket_permalink_with_multi_line_selection() {
        ...
        let expected_url = "https://bitbucket.org/monyacode/monyacode/src/f00b4r/main.rs#lines-24:48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_bitbucket_self_hosted_permalink_with_multi_line_selection() {
        ...
        let expected_url =
            "https://bitbucket.company.com/projects/MonyaCode/repos/monyacode/browse/main.rs?at=f00b4r#24-48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_bitbucket_pull_requests() {
        ...
        assert_eq!(
            pr.url.as_str(),
            "https://bitbucket.org/monyacode/monyacode/pull-requests/123"
        );
    }
    ...
    fn test_bitbucket_self_hosted_pull_requests() {
        ...
        let bitbucket = Bitbucket::from_remote_url("https://bitbucket.company.com/monyacode/monyacode.git").unwrap();
        ...
        assert_eq!(
            pr.url.as_str(),
            "https://bitbucket.company.com/projects/MonyaCode/repos/monyacode/pull-requests/123"
        );
    }
}
