...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    let mut view_items = vec![
        ...
        MenuItem::separator(),
        MenuItem::action("Project Panel", app_actions::project_panel::ToggleFocus),
    ...
    vec![
        Menu {
            name: "MonyaCode".into(),
            items: vec![
                MenuItem::action("About MonyaCode", app_actions::About),
                MenuItem::separator(),
                MenuItem::submenu(Menu {
                    name: "Settings".into(),
                    items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", app_actions::Extensions::default()),
                #[cfg(not(target_os = "windows"))]
                MenuItem::action("Install CLI", install_cli::InstallCliBinary),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide MonyaCode", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit MonyaCode", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Command Palette...", app_actions::command_palette::Toggle),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Edit tasks.jsonc...", crate::monyacode::OpenProjectTasks),
                MenuItem::action("Edit debug.jsonc...", app_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            name: "Help".into(),
            items: vec![
                MenuItem::action("View Dependency Licenses", app_actions::OpenLicenses),
                MenuItem::action("Show Welcome", onboarding::ShowWelcome),
                MenuItem::separator(),
                MenuItem::action(
                    "Documentation",
                    super::OpenMonyaCodeUrl {
                        url: "monyacode://docs/".into(),
                    },
                ),
                MenuItem::action("MonyaCode Repository", super::OpenMonyaCodeRepo),
            ],
        },
    ]
}
