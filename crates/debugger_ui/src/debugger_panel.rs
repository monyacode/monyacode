    ...
    pub(crate) fn top_controls_strip(&mut self, window: &mut Window, cx: &mut Context<Self>) -> Option<Div> {
        ...
        let documentation_button = || {
            IconButton::new("debug-open-documentation", IconName::CircleHelp)
                .icon_size(IconSize::Small)
                .on_click(move |_, _, cx| cx.open_url("monyacode://docs/debugger"))
                ...
                cx.spawn_in(window, async move |workspace, cx| {
                    ...
                    let project_path = workspace.update(cx, |workspace, cx| {
                        workspace
                            ...
                            .context("Couldn't get project path for .monyacode/debug.jsonc in active worktree")
                    })??;
                    ...
                    let welcome_experience = v_flex()
                        ...
                        .child(
                            Button::new("open-debugger-docs", "Debugger Docs")
                                ...
                                .icon_color(Color::Muted)
                                .icon_position(IconPosition::Start)
                                .on_click(|_, _, cx| cx.open_url("monyacode://docs/debugger")),
                        )
                        .child(
