...
pub struct MonyaCodePromptRenderer {
    _level: PromptLevel,
...
impl Render for MonyaCodePromptRenderer {
...
impl EventEmitter<PromptResponse> for MonyaCodePromptRenderer {}

impl Focusable for MonyaCodePromptRenderer {
