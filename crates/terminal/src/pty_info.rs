...
/// Fetches MonyaCode-relevant Pseudo-Terminal (PTY) process information
...
impl PtyProcessInfo {
    ...
    /// Updates the cached process info, returns whether the MonyaCode-relevant info has changed
