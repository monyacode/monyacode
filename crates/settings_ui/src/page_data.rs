        ...
        SettingsPage {
            ...
            items: vec![
                ...
                SettingsPageItem::SettingItem(SettingItem {
                    ...
                    description: "What to restore from the previous session when opening MonyaCode.",
                    field: Box::new(SettingField {
            ...
            items: vec![
                ...
                SettingsPageItem::DynamicItem(DynamicItem {
                    discriminant: SettingItem {
                        files: USER,
                        title: "Icon Theme",
                        description: "The custom set of icons MonyaCode will associate with files and directories.",
                        field: Box::new(SettingField {
                    ...
                    on_click: Arc::new(|settings_window, window, cx| {
                        ...
                        original_window
                            .update(cx, |_workspace, original_window, cx| {
                                original_window
                                    .dispatch_action(app_actions::OpenKeymap.boxed_clone(), cx);
                ...
                let mut items = vec![
                    ...
                    SettingsPageItem::SettingItem(SettingItem {
                        ...
                        field: Box::new(SettingField {
                            ...
                            pick: |settings_content| {
                                settings_content.editor.smooth_scroll.as_ref().and_then(|smooth_scroll| smooth_scroll.enabled.as_ref())
                            },
                            write: |settings_content, value| {
                                settings_content.editor.smooth_scroll.get_or_insert_default().enabled = value;
                            },
                        }),
                        metadata: None,
                        files: USER,
                    ...
                    SettingsPageItem::SettingItem(SettingItem {
                        ...
                        field: Box::new(SettingField {
                            ...
                            pick: |settings_content| {
                                settings_content.editor.smooth_scroll.as_ref().and_then(|smooth_scroll| smooth_scroll.duration.as_ref())
                            },
                            write: |settings_content, value| {
                                settings_content.editor.smooth_scroll.get_or_insert_default().duration = value;
                            },
                        }),
                        metadata: None,
                        files: USER,
        ...
        SettingsPage {
            ...
            items: vec![
                ...
                SettingsPageItem::SettingItem(SettingItem {
                    ...
                    description: "Files or globs of files that will be excluded by MonyaCode entirely. They will be skipped during file scans, file searches, and not be displayed in the project file tree. Takes precedence over \"File Scan Inclusions\"",
                    field: Box::new(
                        SettingField {
                ...
                SettingsPageItem::SettingItem(SettingItem {
                    ...
                    description: "Files or globs of files that will be included by MonyaCode, even when ignored by git. This is useful for files that are not tracked by git, but are still important to your project. Note that globs that are overly broad can slow down MonyaCode's file scanning. \"File Scan Exclusions\" takes precedence over these inclusions",
                    field: Box::new(
                        SettingField {
        ...
        SettingsPage {
            ...
            items: vec![
                ...
                SettingsPageItem::SettingItem(SettingItem {
                    ...
                    description: "(Linux only) whether MonyaCode or your compositor should draw window decorations.",
                    field: Box::new(SettingField {
        ...
        SettingsPage {
            ...
            items: vec![
                ...
                SettingsPageItem::SettingItem(SettingItem {
                    ...
                    description: "Whether breakpoints should be reused across MonyaCode sessions.",
                    field: Box::new(SettingField {
...
fn language_settings_data() -> Vec<SettingsPageItem> {
    let mut items = vec![
        ...
        SettingsPageItem::SettingItem(SettingItem {
            title: "Use Autoclose",
            description: "Whether to automatically type closing characters for you. For example, when you type '(', MonyaCode will automatically add a closing ')' at the correct position.",
            field: Box::new(SettingField {
        ...
        SettingsPageItem::SettingItem(SettingItem {
            ...
            description: "Whether to automatically surround text with characters for you. For example, when you select text and type '(', MonyaCode will automatically surround text with ().",
            field: Box::new(SettingField {
    ...
    items.extend([
        ...
        SettingsPageItem::SettingItem(SettingItem {
            title: "Prefer LSP",
            description: "Use LSP tasks over MonyaCode language extension tasks.",
            field: Box::new(SettingField {
