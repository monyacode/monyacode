...
impl Component for StatusToast {
    ...
    fn preview(_window: &mut Window, cx: &mut App) -> Option<AnyElement> {
        ...
        let success_example = StatusToast::new("Pushed 4 changes to `monyacode/main`", cx, |this, _| {
            this.icon(ToastIcon::new(IconName::Check).color(Color::Success))
        });

        let error_example = StatusToast::new(
            "git push: Couldn't find remote origin `monyacode/monyacode`",
            cx,
            |this, _cx| {
        ...
        let pr_example = StatusToast::new("`monyacode/new-notification-system` created!", cx, |this, _cx| {
