...
impl ThemeColors {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            vim_insert_background: green().light().step_9(),
            vim_replace_background: red().light().step_9(),
            vim_visual_background: blue().light().step_9(),
            vim_visual_line_background: blue().light().step_9(),
            vim_visual_block_background: blue().light().step_9(),
            vim_helix_normal_background: system.transparent,
            vim_helix_select_background: green().light().step_9(),
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            vim_normal_background: system.transparent,
            vim_insert_background: green().dark().step_9(),
            vim_replace_background: red().dark().step_9(),
            vim_visual_background: blue().dark().step_9(),
            vim_visual_line_background: blue().dark().step_9(),
            vim_visual_block_background: blue().dark().step_9(),
            vim_helix_normal_background: system.transparent,
            vim_helix_select_background: green().dark().step_9(),
            vim_mode_text: system.transparent,
        }
    }
}
