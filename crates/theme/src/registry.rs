...
impl ThemeRegistry {
    ...
    pub fn new(assets: Box<dyn AssetSource>) -> Self {
        ...
        // We're loading the MonyaCode default theme, as we need a theme to be loaded
        // for tests.
        registry.insert_theme_families([crate::fallback_themes::monyacode_default_themes()]);
    ...
    /// Loads the themes bundled with the MonyaCode binary and adds them to the registry.
