...
use task::{DebugScenario, MonyaCodeDebugConfig, TcpArgumentsTemplate};
...
pub trait DebugAdapter: 'static + Send + Sync {
    ...
    async fn config_from_monyacode_format(&self, scenario: MonyaCodeDebugConfig) -> Result<DebugScenario>;
