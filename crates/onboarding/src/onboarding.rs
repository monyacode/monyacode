...
use std::sync::Arc;
use ui::{
    Divider, KeyBinding, ParentElement as _, StatefulInteractiveElement, WithScrollbar as _, prelude::*,
};
...
pub const DOCS_URL: &str = "monyacode://docs/";
    ...
    fn new(workspace: &Workspace, cx: &mut App) -> Entity<Self> {
        ...
        cx.new(|cx| {
            ...
            Self {
                ...
                greeting: assets::Assets::random_greeting(),
                        ...
                        v_flex()
                            ...
                            .child(
                                h_flex()
                                    ...
                                    .justify_between()
                                    .child(
                                        h_flex().gap_4().child(img("images/monyacode-logo-monochrome.png").size(rems(6.))).child(
                                            v_flex()
                                                .child(Headline::new("MonyaCode").size(HeadlineSize::Large))
                                                .child(
                                                    Label::new(self.greeting.clone())
