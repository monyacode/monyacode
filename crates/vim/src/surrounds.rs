...
mod test {
    ...
    async fn test_change_surrounds_any_brackets(cx: &mut gpui::TestAppContext) {
        ...
        cx.set_state(indoc! {"(< name: ˇ'MonyaCode' >)"}, Mode::Normal);
        cx.simulate_keystrokes("c s b }");
        cx.assert_state(indoc! {"(ˇ{ name: 'MonyaCode' })"}, Mode::Normal);
    ...
    async fn test_change_surrounds_mini_brackets(cx: &mut gpui::TestAppContext) {
        ...
        cx.set_state(indoc! {"(<ˇMonyaCode>)"}, Mode::Normal);
        cx.simulate_keystrokes("c s b )");
        cx.assert_state(indoc! {"(ˇ(MonyaCode))"}, Mode::Normal);
