        ...
        match event {
            ...
            Event::KeyPress(event) => {
                ...
                let keystroke = {
                    ...
                    let mut keystroke = crate::Keystroke::from_xkb(&key_event_state, modifiers, code);
            ...
            Event::KeyRelease(event) => {
                ...
                let keystroke = {
                    let code = event.detail.into();
                    let keystroke = crate::Keystroke::from_xkb(&key_event_state, modifiers, code);
                    let keysym = key_event_state.key_get_one_sym(code);
...
mod tests {
    ...
    fn test_keymap_with_variant(layouts: &str, variant: &str) -> xkbc::Keymap {
        ...
        xkbc::Keymap::new_from_names(&context, "", "pc105", layouts, variant, None, xkbc::COMPILE_NO_FLAGS)
    ...
    fn key_event_state_uses_event_modifiers_without_mutating_server_state() {
        ...
        let keycode = keymap.key_by_name("AE09").expect("test key should exist in the keymap");
    ...
    fn key_event_state_ignores_pointer_button_bits() {
        ...
        let shifted_with_button_state =
            xkb_state_for_key_event(&server_state, xproto::KeyButMask::SHIFT | xproto::KeyButMask::BUTTON1);
    ...
    fn key_event_state_preserves_non_locked_layout_components() {
        ...
        let keycode = keymap.key_by_name("AD01").expect("test key should exist in the keymap");
    ...
    fn capslock_toggle_produces_uppercase() {
        ...
        let keycode = keymap.key_by_name("AC01").expect("'a' key should exist in the keymap");
    ...
    fn neo2_latched_mod5_preserved() {
        ...
        assert_eq!(key_event_state.serialize_mods(xkbc::STATE_MODS_LATCHED) & mod5, mod5,);
    ...
    fn german_layout_correct_key_resolution() {
        ...
        let keycode = keymap.key_by_name("AE07").expect("'7' key should exist in the keymap");
    ...
    fn macro_shift_bracket_produces_brace() {
        ...
        let bracket = keymap.key_by_name("AD12").expect("']' key should exist in the keymap");
