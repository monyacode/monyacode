...
//! (Though mostly when developing MonyaCode itself, you just need to add a new line to
//!  assets/keymaps/default-{platform}.jsonc).
//!
//! ```ignore
//! cx.bind_keys([
...
//! bubbles up from the bottom. For example in MonyaCode, the Workspace is the top-level view, which contains Pane's, which contain Editors. If there are conflicting keybindings defined
