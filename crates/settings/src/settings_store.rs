...
pub const LSP_SETTINGS_SCHEMA_URL_PREFIX: &str = "monyacode://schemas/settings/lsp/";
...
mod tests {
    ...
    fn test_lsp_settings_schema_generation(cx: &mut App) {
        ...
        let schema = store.json_schema(&SettingsJsonSchemaParams {
            ...
            font_names: &["MonyaCode Mono".to_string()],
            theme_names: &["One Dark".into()],
            icon_theme_names: &["MonyaCode Icons".into()],
        ...
        assert_eq!(init_options_ref, "monyacode://schemas/settings/lsp/rust-analyzer");
    }
}
