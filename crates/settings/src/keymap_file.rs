...
use util::schemars::AllowTrailingCommas;
use util::{
    asset_str,
...
pub struct KeymapSection {
    ...
    /// documentation](monyacode://docs/key-bindings#contexts) for more details.
    #[serde(default)]
    pub context: String,
...
impl KeymapFile {
    ...
    pub fn update_keybinding<'a>(
        ...
        match operation {
            ...
            // that binds it to `monyacode::NoAction`
    ...
    fn keymap_update() {
        ...
        check_keymap_update(
            ...
            KeybindUpdateOperation::add(KeybindUpdateTarget {
                ...
                action_name: "monyacode::SomeAction",
                context: None,
        ...
        check_keymap_update(
            ...
            KeybindUpdateOperation::add(KeybindUpdateTarget {
                ...
                action_name: "monyacode::SomeOtherAction",
                context: None,
                action_arguments: None,
            }),
            r#"[
                ...
                {
                    "bindings": {
                        "ctrl-b": "monyacode::SomeOtherAction"
                    }
                }
            ]"#
            .unindent(),
        ...
        check_keymap_update(
            ...
            KeybindUpdateOperation::add(KeybindUpdateTarget {
                keystrokes: &parse_keystrokes("ctrl-b"),
                action_name: "monyacode::SomeOtherAction",
                context: Some("MonyaCode > Editor && some_condition = true"),
                action_arguments: Some(r#"{"foo": "bar"}"#),
            }),
            r#"[
                {
                ...
                {
                    "context": "MonyaCode > Editor && some_condition = true",
                    "bindings": {
                        "ctrl-b": [
                            "monyacode::SomeOtherAction",
                            {
        ...
        check_keymap_update(
            ...
            KeybindUpdateOperation::Replace {
                target: KeybindUpdateTarget {
                    keystrokes: &parse_keystrokes("ctrl-a"),
                    action_name: "monyacode::SomeNonexistentAction",
                    context: None,
                    action_arguments: None,
                },
                source: KeybindUpdateTarget {
