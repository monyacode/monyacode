...
pub struct SettingsContent {
    ...
    /// This base keymap settings adjusts the default keybindings in MonyaCode to be similar
    /// to other common code editors. By default, MonyaCode's keymap closely follows VSCode's
    ...
    /// Configuration of the terminal in MonyaCode.
    ...
    /// Settings related to Vim mode in MonyaCode.
...
pub struct DebuggerSettingsContent {
    ...
    /// Whether the breakpoints should be reused across MonyaCode sessions.
    ///
    /// Default: true
    ...
    /// Whether to log messages between active debug adapters and MonyaCode
    ///
    /// Default: true
...
pub struct FileFinderSettingsContent {
    ...
    /// Only the file MonyaCode had indexed will be used, not necessary all the gitignored files.
    ///
    /// Default: Smart
...
pub enum IncludeIgnoredContent {
    ...
    All,
    /// Use only the files MonyaCode had indexed
    Indexed,
...
pub struct SshConnection {
    ...
    // By default MonyaCode will download the binary to the host directly.
    // If this is set to true, MonyaCode will download the binary to your local machine,
