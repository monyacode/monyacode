...
///
/// Has an absolute path, and may be set to be visible in MonyaCode UI or not.
...
/// * a directory opened in MonyaCode — may be added as a visible entry to the current worktree
///
...
impl BackgroundScanner {
    ...
    async fn process_events(&self, mut events: Vec<PathEvent>) {
        ...
        // Certain directories may have FS changes, but do not lead to git data changes that MonyaCode cares about.
        // Ignore these, to avoid MonyaCode unnecessarily rescanning git metadata.
