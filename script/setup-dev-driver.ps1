...
$Volume = New-VHD -Path C:/monyacode_dev_drive.vhdx -SizeBytes 100GB |
                    Mount-VHD -Passthru |
...
Dismount-VHD -Path C:/monyacode_dev_drive.vhdx
Mount-VHD -Path C:/monyacode_dev_drive.vhdx
...
Write-Output `
	...
	"MONYACODE_WORKSPACE=$($Drive)/monyacode" `
